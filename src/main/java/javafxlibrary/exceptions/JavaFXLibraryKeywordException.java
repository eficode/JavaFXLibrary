...
public class JavaFXLibraryKeywordException extends RuntimeException {
    ...
    public JavaFXLibraryKeywordException(String string) {
        super(string);
    }

    public JavaFXLibraryKeywordException(Throwable t) {
        super(t);
    }

    public JavaFXLibraryKeywordException(String string, Throwable t) {
        super(string, t);
    }
}
