...
public class JavaFXLibraryNonFatalException  extends JavaFXLibraryKeywordException {
    ...
    public JavaFXLibraryNonFatalException(String string) {
        super(string);
    }

    public JavaFXLibraryNonFatalException(Throwable t) {
        super(t);
    }

    public JavaFXLibraryNonFatalException(String string, Throwable t) {
        super(string, t);
    }
}
