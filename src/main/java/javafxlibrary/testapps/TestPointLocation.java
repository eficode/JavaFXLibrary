...
public class TestPointLocation extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        final Parent view = FXMLLoader.load(getClass().getResource("/fxml/javafxlibrary/ui/TestPointLocationUI.fxml"));
        final Scene scene = new Scene(view);
        stage.setTitle("PointLocation Test");
