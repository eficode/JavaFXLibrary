...
public class TestBoundsLocation extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        final Parent view = FXMLLoader.load(getClass().getResource("/fxml/javafxlibrary/ui/TestBoundsLocationUI.fxml"));
        final Scene scene = new Scene(view);
        stage.setTitle("BoundsLocation Test");
